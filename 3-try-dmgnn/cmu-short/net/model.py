...
class Encoder(nn.Module):
    ...
    def __init__(self, n_in_enc, graph_args_j, graph_args_p, graph_args_b, edge_weighting, fusion_layer, cross_w, **kwargs):
        ...
        A_j_matrix = np.loadtxt("/data_disk/zhangqq/josie-gnn-code/recomb/3-try-dmgnn/data/hic_matrix/nodes_200.txt",dtype=np.int32,delimiter=',')
        A_j_complete_matrix = torch.from_numpy(A_j_matrix)
        A_j = A_j_complete_matrix.unsqueeze(dim=0)
        self.register_buffer('A_j', A_j)

        A_p_matrix = np.loadtxt("/data_disk/zhangqq/josie-gnn-code/recomb/3-try-dmgnn/data/hic_matrix/nodes_40.txt",dtype=np.int32,delimiter=',')
        A_p_complete_matrix = torch.from_numpy(A_p_matrix)
        A_p = A_p_complete_matrix.unsqueeze(dim=0)
        self.register_buffer('A_p', A_p)

        A_b_matrix = np.loadtxt("/data_disk/zhangqq/josie-gnn-code/recomb/3-try-dmgnn/data/hic_matrix/nodes_20.txt",dtype=np.int32,delimiter=',')
        A_b_complete_matrix = torch.from_numpy(A_b_matrix)
        A_b = A_b_complete_matrix.unsqueeze(dim=0)
        self.register_buffer('A_b', A_b)
        #print(A_j.shape)
        #print(A_b.shape)
        #print(A_p.shape)
        ...
        #self.s2_l2 = St_gcn(32, 64, ksize_2, stride=1, **kwargs)
        #self.s2_l3 = St_gcn(64, 128, ksize_2, stride=1, **kwargs)
        #self.s2_l4 = St_gcn(128, 256, ksize_2, stride=1, **kwargs)
        ...
        #self.s3_l2 = St_gcn(32, 64, ksize_3, stride=1, **kwargs)
        #self.s3_l3 = St_gcn(64, 128, ksize_3, stride=1, **kwargs)
        #self.s3_l4 = St_gcn(128, 256, ksize_3, stride=1, **kwargs)
        ...
        if self.fusion_layer == 0:
            ...
            '''
            self.j2p_1 = S1_to_S2(n_j1=32, n_j2=(800, 8), n_p1=32, n_p2=(800, 8), t_kernel=5, t_stride=(1,2), t_padding=2)
            self.p2j_1 = S2_to_S1(n_p1=32, n_p2=(800, 8), n_j1=32, n_j2=(800, 8), t_kernel=5, t_stride=(1,2), t_padding=2)
            self.p2b_1 = S2_to_S3(n_p1=32, n_p2=(800, 8), n_b1=32, n_b2=(800, 8), t_kernel=5, t_stride=(1,2), t_padding=2)
            self.b2p_1 = S3_to_S2(n_b1=32, n_b2=(800, 8), n_p1=32, n_p2=(800, 8), t_kernel=5, t_stride=(1,2), t_padding=2)
            ...
            '''
            self.j2p_1 = S1_to_S2(n_j1=32, n_j2=(800, 4), n_p1=32, n_p2=(800, 4), t_kernel=5, t_stride=(1,2), t_padding=2)
            self.p2j_1 = S2_to_S1(n_p1=32, n_p2=(800, 4), n_j1=32, n_j2=(800, 4), t_kernel=5, t_stride=(1,2), t_padding=2)
            self.p2b_1 = S2_to_S3(n_p1=32, n_p2=(800, 4), n_b1=32, n_b2=(800, 4), t_kernel=5, t_stride=(1,2), t_padding=2)
            self.b2p_1 = S3_to_S2(n_b1=32, n_b2=(800, 4), n_p1=32, n_p2=(800, 4), t_kernel=5, t_stride=(1,2), t_padding=2)
            self.j2p_2 = S1_to_S2(n_j1=64, n_j2=(832, 4), n_p1=64, n_p2=(832, 4), t_kernel=5, t_stride=(1,2), t_padding=2)
            self.p2j_2 = S2_to_S1(n_p1=64, n_p2=(832, 4), n_j1=64, n_j2=(832, 4), t_kernel=5, t_stride=(1,2), t_padding=2)
            self.p2b_2 = S2_to_S3(n_p1=64, n_p2=(832, 4), n_b1=64, n_b2=(832, 4), t_kernel=5, t_stride=(1,2), t_padding=2)
            self.b2p_2 = S3_to_S2(n_b1=64, n_b2=(832, 4), n_p1=64, n_p2=(832, 4), t_kernel=5, t_stride=(1,2), t_padding=2)

            '''
            self.j2p_1 = S1_to_S2(n_j1=32, n_j2=(480, 32), n_p1=32, n_p2=(480, 32), t_kernel=5, t_stride=(1,2), t_padding=2)
            self.p2j_1 = S2_to_S1(n_p1=32, n_p2=(480, 32), n_j1=32, n_j2=(480, 32), t_kernel=5, t_stride=(1,2), t_padding=2)
            self.p2b_1 = S2_to_S3(n_p1=32, n_p2=(480, 32), n_b1=32, n_b2=(480, 32), t_kernel=5, t_stride=(1,2), t_padding=2)
            self.b2p_1 = S3_to_S2(n_b1=32, n_b2=(480, 32), n_p1=32, n_p2=(480, 32), t_kernel=5, t_stride=(1,2), t_padding=2)
            
            self.j2p_2 = S1_to_S2(n_j1=64, n_j2=(512, 8), n_p1=64, n_p2=(512, 8), t_kernel=5, t_stride=(1,2), t_padding=2)
            self.p2j_2 = S2_to_S1(n_p1=64, n_p2=(512, 8), n_j1=64, n_j2=(512, 8), t_kernel=5, t_stride=(1,2), t_padding=2)
            self.p2b_2 = S2_to_S3(n_p1=64, n_p2=(512, 8), n_b1=64, n_b2=(512, 8), t_kernel=5, t_stride=(1,2), t_padding=2)
            self.b2p_2 = S3_to_S2(n_b1=64, n_b2=(512, 8), n_p1=64, n_p2=(512, 8), t_kernel=5, t_stride=(1,2), t_padding=2)
            '''
        else:
...
class Decoder(nn.Module):
    ...
    def __init__(self, n_in_dec, n_hid_dec, graph_args_j, edge_weighting=True, dropout=0.3, **kwargs):
        ...
        self.mask = torch.ones(600).cuda().detach()
