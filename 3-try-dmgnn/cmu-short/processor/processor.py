...
class Processor(IO):
    ...
    def load_data(self):
        if self.arg.debug==True:
            self.actions = define_actions('hic')
        else:
    ...
    def start(self):
        ...
        if self.arg.phase == 'train':
            ...
            #self.mask = torch.ones(29).to(self.dev)
            self.mask[10:] = 2
    ...
    def get_parser(add_help=False):
        ...
        parser.add_argument('--iter_num', type=int, default=100, help='stop training in which epoch')
        ...
        parser.add_argument('--eval_interval', type=int, default=20, help='the interval for evaluating models (#iteration)')
        
        #parser.add_argument('--savemotion_interval', type=int, default=2000000000000, help='the interval for evaluating models (#iteration)')
        parser.add_argument('--savemotion_interval', type=int, default=200, help='the interval for evaluating models (#iteration)')
